...
class Robot:
    ...
    def drive_towards_wall_left(self):
        ...
        if statistics.median(self.data_front_r) > 600 and statistics.median(
                self.data_front_l) > 600:  # OTSI NEED NUMBRID ÜLES ÕIGEL ROBOTIL
            self.left_wheel_speed = 0
            self.right_wheel_speed = 0
    ...
    def forward_until_between_walls(self):
        ...
        if statistics.median(self.data_r) > 600 and statistics.median(self.data_l) > 600:  # NEED NUMBRID KA
            self.state = "forward"
        self.left_wheel_speed = -10
        self.right_wheel_speed = -10
    ...
    def spin(self):
        ...
        while not self.shutdown:
            print(f"data_front_r: {statistics.median(self.data_front_r)}")
            print(f"data_front_l: {statistics.median(self.data_front_l)}")
